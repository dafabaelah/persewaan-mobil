...
@section('content')
    <div class="mt-4 mb-5 flex justify-start">
        <a href="{{ route('carCreate') }}" class="text-white bg-yellow-900 hover:bg-yellow-700 focus:ring-4 focus:outline-none focus:ring-yellow-700 font-medium rounded-lg text-sm px-4 py-2 dark:bg-yellow-900 dark:hover:bg-yellow-700 dark:focus:ring-yellow-700">
            Add Car
        </a>
    </div>
